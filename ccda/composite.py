...
parser.add_argument("--hr_img_dir", default='./data/train/image', type=str)
parser.add_argument("--hr_lbl_dir", default='./data/train/label', type=str)
parser.add_argument("--img_dir", default='./data/train/image', type=str)
parser.add_argument("--lbl_dir", default='./data/train/label', type=str)
...
parser.add_argument("--aug_img_dir", default='./data/train/image', type=str)
parser.add_argument("--aug_lbl_dir", default='./data/train/label', type=str)
